...
//    public static MetaItem<?>.MetaValueItem KEBAB_CHICKEN;
    ...
    public void registerSubItems() {
        ...
        ORGANIC_CIRCUIT_15 = addItem(175, "circuit.organic.ulv").addComponents(new GTFOFoodStats(1, 1f, false, true, ItemStack.EMPTY)
                .setEatingDuration(1));
        ORGANIC_CIRCUIT_1 = addItem(176, "circuit.organic.lv").addComponents(new GTFOFoodStats(2, 1.5f, false, true, ItemStack.EMPTY)
                .setEatingDuration(1));
        ORGANIC_CIRCUIT_2 = addItem(177, "circuit.organic.mv").addComponents(new GTFOFoodStats(4, 2f, false, true, ItemStack.EMPTY)
                .setEatingDuration(1));
        ORGANIC_CIRCUIT_3 = addItem(178, "circuit.organic.hv").addComponents(new GTFOFoodStats(8, 2.5f, false, true, ItemStack.EMPTY)
                .setEatingDuration(1));
        ORGANIC_CIRCUIT_4 = addItem(179, "circuit.organic.ev").addComponents(new GTFOFoodStats(16, 3f, false, true, ItemStack.EMPTY)
                .setEatingDuration(1));
        ORGANIC_CIRCUIT_5 = addItem(180, "circuit.organic.iv").addComponents(new GTFOFoodStats(32, 3.5f, false, true, ItemStack.EMPTY)
                .setEatingDuration(1));
        ORGANIC_CIRCUIT_6 = addItem(181, "circuit.organic.luv").addComponents(new GTFOFoodStats(64, 4f, false, true, ItemStack.EMPTY)
                .setEatingDuration(1));
        ORGANIC_CIRCUIT_7 = addItem(182, "circuit.organic.zpm").addComponents(new GTFOFoodStats(128, 4.5f, false, true, ItemStack.EMPTY)
                .setEatingDuration(1));
        ORGANIC_CIRCUIT_8 = addItem(183, "circuit.organic.uv").addComponents(new GTFOFoodStats(256, 5f, false, true, ItemStack.EMPTY)
                .setEatingDuration(1));
        ORGANIC_CIRCUIT_9 = addItem(184, "circuit.organic.uhv").addComponents(new GTFOFoodStats(512, 5.5f, false, true, ItemStack.EMPTY)
                .setEatingDuration(1));
        ORGANIC_CIRCUIT_10 = addItem(185, "circuit.organic.uev").addComponents(new GTFOFoodStats(1024, 6f, false, true, ItemStack.EMPTY)
                .setEatingDuration(1));
        ORGANIC_CIRCUIT_11 = addItem(186, "circuit.organic.uiv").addComponents(new GTFOFoodStats(2048, 6.5f, false, true, ItemStack.EMPTY)
                .setEatingDuration(1));
        ORGANIC_CIRCUIT_12 = addItem(187, "circuit.organic.uxv").addComponents(new GTFOFoodStats(4096, 7f, false, true, ItemStack.EMPTY)
                .setEatingDuration(1));
        ORGANIC_CIRCUIT_13 = addItem(188, "circuit.organic.opv").addComponents(new GTFOFoodStats(8192, 7.5f, false, true, ItemStack.EMPTY)
                .setEatingDuration(1));
        ORGANIC_CIRCUIT_14 = addItem(189, "circuit.organic.max").addComponents(new GTFOFoodStats(16384, 8f, false, true, ItemStack.EMPTY)
                .setEatingDuration(1));
